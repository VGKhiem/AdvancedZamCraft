...
- **`StatScales`**:
  - Ví dụ: `Strength_PhysDmg: 0.05` ➡️ Mỗi 1 điểm **Sức mạnh (Strength)** người chơi tăng thêm, họ sẽ nhận được thêm `0.05` Sát thương vật lý (`PHYSICAL_DAMAGE`).
  - Ví dụ: `Vitality_HP: 5.0` ➡️ Mỗi 1 điểm **Thể lực (Vitality)** người chơi tăng thêm, họ sẽ nhận được thêm `5.0` Máu tối đa (`HEALTH`).
  - Cấu hình hệ số quy đổi chỉ số cho 5 thuộc tính tiềm năng chính: **Sức mạnh** (`Strength`), **Nhanh nhẹn** (`Agility`), **Thể lực** (`Vitality`), **Trí tuệ** (`Energy`), **Khéo léo** (`Dexterity`).
...
- **Kinh nghiệm từ Mobs (<span style="color: #1abc9c; font-weight: bold;">Exp</span>)**: Đây là thuộc tính tự định nghĩa riêng (Custom) của AdvancedZamCraft. Bạn cấu hình thêm khoá <code><span style="color: #1abc9c;">Exp: &lt;số_lượng&gt;</span></code> vào tệp cấu hình quái vật để cộng kinh nghiệm khi người chơi hạ quái.
- **Tiền rớt từ Mobs (<span style="color: #e2c027; font-weight: bold;">Money</span>)**: Đây là thuộc tính tự định nghĩa riêng (Custom) của AdvancedZamCraft. Bạn cấu hình thêm khoá <code><span style="color: #e2c027;">Money: &lt;số_lượng&gt;</span></code> vào tệp cấu hình quái vật để thưởng tiền vàng khi người chơi hạ quái.
- **Linh Hồn (<span style="color: #8e44ad; font-weight: bold;">Soul</span>)**: Đây là thuộc tính tự định nghĩa riêng (Custom) của AdvancedZamCraft. Bạn cấu hình thêm khoá <code><span style="color: #8e44ad;">Soul: &lt;số_lượng&gt;</span></code> vào tệp cấu hình quái vật để cộng Linh Hồn nội bộ khi người chơi hạ quái.

<div style="border-left: 4px solid #2980b9; padding: 6px 12px; margin: 15px 0;">
  <span style="color: #2980b9; font-weight: bold; font-size: 1.1em;">ℹ️ PHÂN BIỆT LOẠI BIẾN:</span><br>
  - <span style="color: #8e44ad; font-weight: bold;">Soul</span>, <span style="color: #1abc9c; font-weight: bold;">Exp</span> và <span style="color: #e2c027; font-weight: bold;">Money</span>: Là biến tuỳ chỉnh riêng của plugin AdvancedZamCraft.
</div>
...
<div style="border-left: 4px solid #e74c3c; padding: 6px 12px; margin: 15px 0;">
  ...
  Hãy thêm dòng <span style="color: #8e44ad; font-weight: bold;">Soul: &lt;số_lượng&gt;</span> trực tiếp vào file cấu hình quái vật của MythicMobs để kích hoạt tính năng rơi Linh Hồn.
</div>
